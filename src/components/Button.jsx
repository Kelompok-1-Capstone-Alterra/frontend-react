export default function Button({
	...
	const variants = {
		...
		text: "text-primary border-none hover:text-primary-hover hover:bg-transparent active:text-primary-pressed disabled:text-neutral-40 disabled:hover:text-neutral-40",
	};
